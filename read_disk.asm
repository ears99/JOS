read_disk:
	...
	mov dh, 0 ;first head
	;NOTE: mov al and cl are put into main.asm
	...
	mov es, bx
	pop bx
	mov bx, 0x7C00 + 512 ;load us 512 bytes after 0x7C00
...
disk_error:
	;mov si, DISK_ERR_MSG ;move DISK_ERR_MSG into si
	;call print_str ;call the print_str subroutine
